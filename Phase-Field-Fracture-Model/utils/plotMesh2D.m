function plotMesh2D(PHTelem,controlPts,geometry,miter,step,writeElem)
...
% id_step = num2str(step);
% save_name_prev_prev = append(id_step, '_step_iter_');
% miter_step = num2str(miter);
% save_name_prev = append(save_name_prev_prev, miter_step);
% save_name = append(save_name_prev, '_mesh_coords.mat');
% save(save_name, 'coords')
end
